 ...
 */
const getPanoramaId = async (point: Point): Promise<string> => {
	const location = point.toString(),
 ...
 */
const getPanoramaBase64 = async (point: Point, heading: number = 90): Promise<string> => {
	const location = point.toString(),
